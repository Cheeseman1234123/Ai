...
def display_image(title, image):
    """Utility function to displya an image"""
    ...
    plt.axis('off')
    plt.show()
def interactive_edge_direction(image_path):
    ...
    while True:
        ...
        if choice == "1":
            ...
            print("Adjust kernel size for Gussian blur (must be odd, default:5)")
...
interactive_edge_direction('images.jpg')